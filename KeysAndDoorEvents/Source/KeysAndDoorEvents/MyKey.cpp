...
void AMyKey::Tick(float DeltaTime) { Super::Tick(DeltaTime); }

void AMyKey::OnOverlap(UPrimitiveComponent *OverlappedComp, AActor *Other, UPrimitiveComponent *OtherComp,
